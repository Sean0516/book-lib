...
1. 根据生产速率、消费速率和故障时长估算积压规模。
2. 为什么增加消费者可能把数据库或下游再次打垮？
3. 恢复阶段如何计算净清理速度并控制放量？

答不完整时回到[消息积压计算](/deep-dives/data-reliability/03-messaging-reliability#backlog)，补齐容量、限速和恢复验证。
